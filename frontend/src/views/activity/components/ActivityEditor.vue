      ...
      <div class="createPost-main-container">
        ...
        <div class="editor-container">
          <el-form-item label-width="80px" label="模版代码:" class="postInfo-container-item">
            ...
            <ruby-editor ref="rubyEditor" :height=400 v-model="templat"></ruby-editor>
        </div>
      </div>
    </el-form>
...
export default {
  name: 'activityEditor',
  components: { MDinput, Upload, Multiselect, Sticky, rubyEditor },
  props: {
    isEdit: {
      type: Boolean,
      default: false
  ...
  data() {
    return {
      id: -1,
      value: '',
      templat: "require 'json'\n puts 123321",
      postForm: Object.assign({}, defaultForm),
      fetchSuccess: true,
      loading: false,
      accounts: [{name: '123', id: 1}]
    }
  },
  computed: {
  },
